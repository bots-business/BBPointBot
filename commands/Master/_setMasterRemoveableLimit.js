...
var masterRemoveableLimit = Libs.ResourcesLib.anotherUserRes("masterRemoveableLimit",masterId);
masterRemoveableLimit.set(parseInt(message))

Bot.sendMessage("*Please enter the amount for Master Removeable Points per hours*\nFor the user :- `" +  masterId  + "`\n\nUse /cancel to cancel the command")
Bot.run({
